package com.vivianrosa.findtime.android.ui.screens.findmeetingtime
...
import com.vivianrosa.findtime.android.ui.components.dialogs.MeetingDialog
import com.vivianrosa.findtime.android.ui.components.dialogs.isSelected
import com.vivianrosa.findtime.android.ui.screens.findmeetingtime.components.NumberTimeCard
...
@Composable
private fun Preview() {
    FindMeetingTimeScreen(timezoneStrings = listOf("America", "ACT", "ATG"))
}